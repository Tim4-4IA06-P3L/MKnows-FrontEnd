...
const CoverPage: FC<coverPage> = ({ bgSrc, coverTitle, subTitle }) => {
  return (
    <div
      className="relative w-full bg-right-top bg-contain bg-no-repeat z-0"
      style={{
    ...
    >
      <div className="relative flex w-[65%] justify-start items-center">
        <div className="absolute text-lg sm:text-3xl md:text-4xl lg:text-6xl font-semibold p-8">
          ...
          <p>
            <strong className="sm:text-2xl md:text-3xl lg:text-5xl text-sky-600">
              {subTitle}
            </strong>
          </p>
        </div>
