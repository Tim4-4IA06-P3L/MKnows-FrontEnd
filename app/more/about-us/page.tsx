        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          <div className="flex items-center md:order-1 order-2">
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg text-justify mx-10 md:mr-0">
              ...
              merupakan induk perusahaan dari PT. Menara Pengetahuan Indonesia,
              perusahaan yang bergerak dalam bidang jasa pendidikan dan
              pelatihan, berkantor pusat di Jakarta dan memiliki cabang di
              Surabaya.
            </p>
          </div>
