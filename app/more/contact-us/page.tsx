      ...
      <div className="min-h-screen bg-white flex flex-col sm:flex-row items-center justify-center p-8 gap-8">
				...
				<div className="basis-[50%] flex flex-col justify-start gap-5">
					...
					<p className="text-justify text-2xl">
						Jika Anda memiliki pertanyaan atau membutuhkan bantuan lebih lanjut, tim kami siap membantu! 
						Hubungi kami langsung melalui WhatsApp!
					</p>
					<Link href="https://wa.me/081210468281" className="rounded-md p-5 bg-green-800 hover:bg-green-900 flex justify-start gap-5 items-center w-max">
