...
export const metadata: Metadata = {
  title: "Contact Us - M-Knows Consulting",
  description: "Halaman Contact Us (Kontak Kami) M-Knows Consulting",
};
        ...
        <div className="min-h-screen bg-white flex flex-col sm:flex-row items-center justify-center p-8 gap-8">
          ...
          <div className="basis-[50%] flex flex-col justify-start gap-5">
            ...
            <Link
              ...
              className="rounded-md p-5 bg-green-800 hover:bg-green-900 flex justify-start gap-5 items-center w-max"
            >
