        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          ...
          <div className="flex items-center">
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg text-justify">
              ...
              Manusia dengan materi tertentu seperti Selling Skills, Leadership,
              Executive Coaching &amp; Business Mentoring, Train The Trainer,
              Collection Skills, Credit Analysis dan lain-lain sesuai kebutuhan
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          <div className="flex items-center md:order-1 order-2">
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg text-justify">
              ...
              materi, dan jadwal yang sesuai dengan kebutuhan bisnis. Sejak
              tahun 2003, kami telah menyelenggarakan pelatihan internal di
              banyak perusahaan dan lembaga perbankan. Kami telah mengembangkan
              materi yang sesuai dengan kebutuhan bisnis atau lembaga yang ingin
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
          ...
          <div className="flex items-center">
            <p className="text-gray-700 text-sm sm:text-base lg:text-lg text-justify">
              ...
              (10-20 peserta) atau kelas besar (lebih dari 50 peserta).
