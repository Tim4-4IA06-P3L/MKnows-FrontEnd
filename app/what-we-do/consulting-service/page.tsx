      ...
      >
        ...
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            ...
            saling menguntungkan dengan berbagai perusahaaan yang memiliki visi
            untuk sukses, dan komitmen untuk mencapai kesuksesan itu melalui
      ...
      >
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            ...
            segala hal. Program pengembangan berkaitan dengan tahap pengembangan
            perusahaan dan tujuan jangka pendek serta jangka panjang mereka,
            baik saat start up, dalam ekspansi, dalam masa transisi atau
            berbalik. Perusahaan harus merencanakan dan merancang program
            pembangunan dengan hati-hati sesuai dengan setiap lapisan manajemen
            seperti : MT (Management Trainee), Leadership Program & Consulting.
          </p>
        </div>
      ...
      >
        ...
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            ...
            mempersiapkan sumber daya manusia baru untuk suatu posisi pekerjaan
            atau regenerasi, maupun mempersiapkan pensiun. M-Knows Consulting
            mendukung perusahaan dan bekerja sinergis dengan pusat-pusat
            pelatihan dalam menilai kebutuhan pelatihan, pengembangan pelatihan
            customized program, melakukan dan mengevaluasi pelatihan bagi staf
            profesional dan eksekutif. Konsultan yang berpengalaman dan
            berdedikasi tinggi memampukan M-Knows Consulting dalam menyusun
            materi pelatihan, menyampaikan materi pelatihan, serta metode
            evaluasi dalam rangka memperoleh hasil pelatihan yang terbaik.
          </p>
        </div>
      </section>
