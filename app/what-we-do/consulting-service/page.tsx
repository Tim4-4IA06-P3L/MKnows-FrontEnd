        ...
        <section>
				...
				<section className="w-full flex flex-row p-10 md:p-20 justify-around items-center 
					...
					<div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
						<strong className="text-2xl text-[#1C75BC]">Kami telah menjadi mitra terpercaya (lebih dari 15 tahun)</strong>
				...
				<section className="w-full flex flex-row p-10 md:p-20 justify-around items-center 
					...
					<div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
						<strong className="text-2xl text-[#ED8222]">Pengembangan Sumber Daya Manusia</strong>
						<p className="text-justify mt-5">
				...
				<section className="w-full flex flex-row p-10 md:p-20 justify-around items-center 
					...
					<div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
						<strong className="text-2xl text-[#983EB1]">Program Pelatihan yang Efektif</strong>
						<p className="text-justify mt-5">
				...
				<section className="relative w-full flex flex-col items-center min-[320px]:max-md:mt-32 mt-20">
					...
					<div className="absolute w-4/5 -translate-y-1/2 p-3 md:p-6 bg-[#AECFDF]">
						<strong className="text-bold text-xl min-[320px]:max-md:text-md">M-Knows Consulting telah memperoleh banyak kesempatan bekerja sama</strong>
