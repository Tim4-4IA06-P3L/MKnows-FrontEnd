    ...
    <main>
      ...
      <section className="h-max w-full flex flex-col items-center p-10 md:p-20">
        ...
        <p className="text-justify last-center">
          ...
          tinggi. Penguatan kompetensi dilakukan berupa pelatihan selama 1 bulan
          di M-Knows, fokus pada role play dan drill, ditutup dengan uji
          kompetensi. Mereka yang lulus uji kompetensi, disalurkan untuk 1 bulan
          magang di perusahaan (Bank, Multi Finance, Fintech, dan Asuransi).
          Bagi yang berkinerja tinggi akan ditawarkan untuk bekerja di
          perusahaan yang berpartisipasi, bekerja di industri keuangan.
        </p>
      </section>
        ...
        <div className="min-[320px]:max-sm:w-full w-[78%] text-center">
          ...
          <ol className="text-justify mt-5 text-left list-decimal list-inside marker:text-xl marker:text-[#1C75BC]">
            ...
            <li>
              ...
              yang sudah lulus atau maksimal selama COVID-19, (2 tahun terakhir)
      ...
      >
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            ...
            dapat diterima bekerja di perusahaan keuangan, yang bernama Officer
            Development Crash Program (ODCP). ODCP memiliki keunggulan, karena
            mahasiswa diberikan kemampuan atau keahlian yang spesifik, seperti
            Sales, Credit dan Collection sesuai kebutuhan dari perusahaan
            keuangan yang menerimanya.
          </p>
      ...
      >
        ...
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            ...
            akhir, dan uji kompetensi (studi kasus, role play, dan drill) untuk
            ...
            <div className="flex flex-row justify-start items-center min-[320px]:max-sm:space-x-4 space-x-8 min-[320px]:max-md:space-x-8 ml-16 min-[320px]:max-md:ml-8">
              ...
              <div>
                ...
                <p className="text-justify min-[320px]:max-md:hidden">
                  ...
                  kompetensi akan diidentifikasi dan ditentukan solusi
                  perbaikannya.
                </p>
              </div>
            </div>
