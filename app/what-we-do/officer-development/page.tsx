	...
	return (
		<main>
			...
			<section className="h-max w-full flex flex-col items-center p-10 md:p-20">
				<strong className="text-2xl text-center mb-5 text-[#9DE000]">Pengembangan Program Singkat Hybrid Proyek Lingkup</strong>
				<p className="text-justify last-center">
					Officer Development Crash Program adalah program pelatihan & magang yang merupakan penciptaan kompetensi 
					di bidang Sales, Credit & Collection, guna menghasilkan SDM yang produktif dan berkinerja tinggi. Penguatan 
					kompetensi dilakukan berupa pelatihan selama 1 bulan di M-Knows, fokus pada role play dan drill, ditutup dengan 
					uji kompetensi. Mereka yang lulus uji kompetensi, disalurkan untuk 1 bulan magang di perusahaan (Bank, Multi Finance, 
					Fintech, dan Asuransi). Bagi yang berkinerja tinggi akan ditawarkan untuk bekerja di perusahaan yang berpartisipasi, 
					bekerja di industri keuangan.
				</p>
			</section>
			...
			<section className="w-full flex flex-row p-10 md:p-20 justify-around items-center 
				...
				<div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
					<strong className="text-2xl text-[#1C75BC]">Kerangka Program (Project Framework)</strong>
					<p className="text-justify mt-5">
						Aktivitas magang yang kami rancang adalah untuk mahasiswa dapat dapat diterima bekerja di perusahaan keuangan, 
						yang bernama Officer Development Crash Program (ODCP). ODCP memiliki keunggulan, karena mahasiswa diberikan 
						kemampuan atau keahlian yang spesifik, seperti Sales, Credit dan Collection sesuai kebutuhan dari perusahaan keuangan 
						yang menerimanya.
					</p>
					
					<p className="text-justify mt-5">
						Pendekatan kerja dan magang akan menggunakan pendekatan SCRUM Framework, dimana pemegang akan diarahkan untuk merancang 
						solusi melalui lima proses iteratif, yaitu Sprint Planning, Daily SCRUM, Sprint Review, Sprint Retrospective, dan Improvement.
					</p>
				</div>
			...
			<section className="w-full flex flex-row p-10 md:p-20 justify-around items-center 
				...
				<div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
					<strong className="text-2xl text-[#9DE000]">Proses Pelatihan di Kampus Gratis</strong>
					<p className="text-justify mt-5">
						Materi diberikan secara synchronous (online meeting) dan asynchronous (video ajar dan white paper 
						di <a href="https://kampusgratis.id" className="text-[#1C75BC] underline" target="_blank">kampusgratis.id</a>). Sesi tatap muka 
						diperlukan untuk penugasan dan mentoring langsung. Setiap materi dilengkapi kuis, latihan, penugasan, ujian akhir, dan uji kompetensi 
						(studi kasus, role play, dan drill) untuk evaluasi standar kompetensi.
					</p>
				</div>
			</section>
