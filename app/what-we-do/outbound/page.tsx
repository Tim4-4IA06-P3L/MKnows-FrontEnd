      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 p-8">
        ...
        <div className="md:w-1/2 w-full text-gray-800 text-justify xl:mr-20">
          ...
          <p className="mt-4 text-lg leading-relaxed">
            Outbound training sangat cocok untuk perusahaan, baik swasta maupun
            instansi pemerintah, yang ingin meningkatkan kinerja karyawan
            mereka. Program ini dapat meningkatkan kreativitas, membangun jiwa
            kepemimpinan, memperkuat kerjasama tim, menumbuhkan kebersamaan,
            serta rasa saling percaya dan tanggung jawab. Melalui kegiatan yang
            menyenangkan, karyawan perusahaan Anda akan mendapatkan banyak
            pelajaran yang dapat diterapkan untuk meningkatkan kinerjanya.
          </p>
        </div>
      </div>
        ...
        {packages.map((pkg, index) => (
          ...
          >
            ...
            <div className="w-1/2 pl-4 flex items-stretch justify-center">
              <h2 className="md:text-2xl text-lg text-lime-700">{pkg.title}</h2>
            </div>
          </div>
        ))}
      </div>
