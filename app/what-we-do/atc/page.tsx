    ...
    <main>
      ...
      <section className="w-full flex flex-col items-center p-10 md:p-20">
        ...
        <p className="text-justify last-center">
          ...
          integratif melalui metode terstandar dan sesuai dengan kebutuhan untuk
          menyesuaikan dengan kebutuhan pengembangan bakat/minat individu.
        </p>
      </section>
      ...
      >
        ...
        <div className="w-3/5 min-[320px]:max-md:text-center min-[320px]:max-md:w-full">
          ...
          <p className="text-justify mt-5">
            Untuk mengoptimasi pengembangan bakat melalui metode dan sarana yang
            valid dan terpercaya. Kami juga memberikan laporan yang unik dan
            dipersonalisasikan oleh para asesor dan penasihat kami untuk
            memberikan informasi yang lengkap serta pengembangan jangka panjang
            kepada client.
          </p>
        </div>
      </section>
